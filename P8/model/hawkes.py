...
class hawkes_parameter(nn.Module):
    def __init__(self,num_nodes,num_event_type):
        ...
        nn.init.uniform_(self.input_w, a=0, b=1e-3)
        nn.init.uniform_(self.input_u, a=0, b=1e-3)
        nn.init.uniform_(self.input_d, a=0, b=1e-3)
        nn.init.uniform_(self.output_u, a=0, b=1e-3)
        nn.init.uniform_(self.output_w, a=0, b=1e-3)
        nn.init.uniform_(self.output_d, a=0, b=1e-3)
        nn.init.uniform_(self.forget_u, a=0, b=1e-3)
        nn.init.uniform_(self.forget_d, a=0, b=1e-3)
        nn.init.uniform_(self.forget_w, a=0, b=1e-3)
        nn.init.uniform_(self.limit_w, a=0, b=1e-3)
        nn.init.uniform_(self.limit_u, a=0, b=1e-3)
        nn.init.uniform_(self.limit_d, a=0, b=1e-3)
        nn.init.uniform_(self.input_u2, a=0, b=1e-3)
        nn.init.uniform_(self.input_d2, a=0, b=1e-3)
        nn.init.uniform_(self.input_w2, a=0, b=1e-3)
        nn.init.uniform_(self.output_u2, a=0, b=1e-3)
        nn.init.uniform_(self.output_d2, a=0, b=1e-3)
        nn.init.uniform_(self.output_w2, a=0, b=1e-3)
        nn.init.uniform_(self.forget_u2, a=0, b=1e-3)
        nn.init.uniform_(self.forget_d2, a=0, b=1e-3)
        nn.init.uniform_(self.forget_w2, a=0, b=1e-3)
        nn.init.uniform_(self.limit_d2, a=0, b=1e-3)
        nn.init.uniform_(self.limit_u2, a=0, b=1e-3)
        nn.init.uniform_(self.limit_w2, a=0, b=1e-3)
